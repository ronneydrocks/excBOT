...
# GLOBAL
########################################################################
spread_BTC_USDT = config.spread_BTC_USDT    # SPREAD entre os preços em USDT
minima_BTC_USDT = config.minima_BTC_USDT    # COMPRA MÍNIMA
...
####################################################################################
            ...
            if vendaAtivoBLEU < compraAtivoEXC and compraAtivoEXC - vendaAtivoBLEU > spread_BTC_USDT:
                ########################################################################
                #     OPORTUNIDADE     
                ########################################################################
                print(f'\n>> OPORTUNIDADE << VENDA na BLEU mais barata que COMPRA na EXC e SPREAD acima de: {spread_BTC_USDT:.8f} USDT\n')
...
##########################################################################################
                    ...
                    if respostaResult == listaErro1[0]:
                        ...
                        if config.funcVendaQuantidadeMinima == 1:
                            ...
                            print(f'Quantidade mínima configurada para BTC_USDT: {minima_BTC_USDT}\n')
                            func.vendaMinimaEXC_BTC_USDT()
                            time.sleep(1)
                    ...
                    if respostaFazCompra == 'ERR_INSUFICIENT_BALANCE':
                        ...
                        log.write(f'{dataEhora}, BTC_USDT, {vendaAtivoBLEU:.8f}, {compraAtivoEXC:.8f}, {quantidade_vendendoBLEU:.8f}, {vPercentual:.2f}, {calculoArbitragem:.8f}, {pagafee:.8f}\n')
                        log.close()                        
...
##########################################################################################
                    ...
                    if respostaFazCompra == 'ERR_INSUFICIENT_BALANCE':
                        ...
                        log = open('logs/BTC_USDT.txt', 'a')
                        log.write(f'{dataEhora}, BTC_USDT, {vendaAtivoBLEU:.8f}, {compraAtivoEXC:.8f}, {quantidade_comprandoEXC:.8f}, {vPercentual:.2f}, {calculoArbitragem:.8f}, {pagafee:.8f}\n')
...
####################################################################################
            ...
            elif vendaAtivoBLEU < compraAtivoEXC and compraAtivoEXC - vendaAtivoBLEU < spread_BTC_USDT:
                print(f'\n>> AGUARDE << VENDA na BLEU mais barata que COMPRA na EXC, mas SPREAD abaixo de: {spread_BTC_USDT:.8f} USDT\n')
...
####################################################################################
            ...
            if vendaAtivoEXC < compraAtivoBLEU and compraAtivoBLEU - vendaAtivoEXC > spread_BTC_USDT:
                ########################################################################
                #     OPORTUNIDADE     
                ########################################################################
                
                print(f'\n>> OPORTUNIDADE << VENDA na EXC mais barata que COMPRA na BLEU e SPREAD acima de: {spread_BTC_USDT:.8f} USDT\n')
...
####################################################################################
                    ...
                    if respostaFazCompraEXC == 'ERR_INSUFICIENT_BALANCE':
                        ...
                        log = open('logs/BTC_USDT.txt', 'a')
                        log.write(f'{dataEhora}, BTC_USDT, {vendaAtivoEXC:.8f}, {compraAtivoBLEU:.8f}, {quantidade_vendendoEXC:.8f}, {vPercentual:.2f}, {calculoArbitragem:.8f}, {pagafee:.8f}\n')
                        log.close()
...
####################################################################################
                    ...
                    if respostaFazCompraEXC == 'ERR_INSUFICIENT_BALANCE':
                        ...
                        log = open('logs/BTC_USDT.txt', 'a')
                        log.write(f'{dataEhora}, BTC_USDT {vendaAtivoEXC:.8f}, {compraAtivoBLEU:.8f}, {quantidade_comprandoBLEU:.8f}, {vPercentual:.2f}, {calculoArbitragem:.8f}, {pagafee:.8f}\n')
                        log.close()
...
####################################################################################
            ...
            elif vendaAtivoEXC < compraAtivoBLEU and compraAtivoBLEU - vendaAtivoEXC < spread_BTC_USDT:
                print(f'\n>> AGUARDE << Venda na EXC está mais barata que compra na BLEU, mas SPREAD abaixo de {spread_BTC_USDT:.8f} USDT\n')
        ...
        log = open('logs/erroBTC_USDT.txt', 'a')
        log.write(f'ERRO: {e}\n')
        log.close()
