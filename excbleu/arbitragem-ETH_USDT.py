...
spread_ETH_USDT = config.spread_ETH_USDT
...
##########################################################################################
                    ...
                    if respostaFazCompra == 'ERR_INSUFICIENT_BALANCE':
                        ...
                        if funCompraMinima == 1:
                            ...
                            # calcula fee
                            pagafee = (feeBLEU / 100) * minimaCompra_ETH_USDT
                            print(f'Fee: {pagafee:.8f}')

                            faz_compra = key_secretBLEU.buy_limit('ETH_USDT', vendaAtivoBLEU, minimaCompra_ETH_USDT)
                            print(f'(1)Comprando... {minimaCompra_ETH_USDT:.8f} ETH')
                            print(faz_compra)

                            # Mensagem Telegram
                            config.mensagem_telegram('>>> FAZENDO COMPRA MÍNIMA <<<')
                            config.mensagem_telegram(
                                f'>> VALORES: \nCompra: {vendaAtivoBLEU:.8f} \nVenda: {compraAtivoEXC:.8f} \nQuantidade: {minimaCompra_ETH_USDT:.8f}\n')
                            config.mensagem_telegram(
                                f'>> AÇÃO:\nComprando na BLEU... {minimaCompra_ETH_USDT:.8f}\n{faz_compra}\n')
                            ...
                            ######################################
                            print(f'\nTransferindo... {minimaCompra_ETH_USDT:.8f} ETH')
                            mCOMPRA = str(minimaCompra_ETH_USDT)
                            urlDirecttransferBLEU = 'https://bleutrade.com/api/v3/private/directtransfer?apikey=' + keyBLEU + '&nonce=' + str(
                                int(
                            ...
                            ######################################################
                            print(f'\nVENDENDO... {minimaCompra_ETH_USDT:.8f} ETH')
                            faz_vendaEXC = key_secretEXC.sell_limit('ETH_USDT', compraAtivoEXC, minimaCompra_ETH_USDT)
                            print(faz_vendaEXC)
...
##########################################################################################
                    ...
                    if respostaFazCompra == 'ERR_INSUFICIENT_BALANCE':
                        ...
                        if funCompraMinima == 1:
                            ...
                            faz_compra = key_secretBLEU.buy_limit('ETH_USDT', vendaAtivoBLEU, minimaCompra_ETH_USDT)
                            print(f'(2)Comprando... {minimaCompra_ETH_USDT:.8f} ETH')
                            print(faz_compra)
                            ...
                            # Faz TRANSFERÊNCIA da BLEU para EXC #
                            ######################################
                            print(f'Transferindo... {minimaCompra_ETH_USDT:.8f} ETH')
                            mCOMPRA = str(minimaCompra_ETH_USDT)
                            urlDirecttransferBLEU = 'https://bleutrade.com/api/v3/private/directtransfer?apikey=' + keyBLEU + '&nonce=' + str(
                                int(
                                    time.time())) + '&asset=ETH&quantity=' + mCOMPRA + '&exchangeto=2&' + 'accountto=' + emailEXC
                            ...
                            # Faz VENDA na EXC: MOEDA_MERCADO, preço, quantidade #
                            ######################################################
                            print(f'Vendendo... {minimaCompra_ETH_USDT:.8f} ETH')
                            faz_vendaEXC = key_secretEXC.sell_limit('ETH_USDT', compraAtivoEXC, minimaCompra_ETH_USDT)
                            print(faz_vendaEXC)
...
####################################################################################
                    ...
                    if respostaFazCompraEXC == 'ERR_INSUFICIENT_BALANCE':
                        ...
                        if funCompraMinima == 1:
                            ...
                            faz_compra = key_secretEXC.buy_limit('ETH_USDT', vendaAtivoEXC, minimaCompra_ETH_USDT)
                            print(f'COMPRANDO... {minimaCompra_ETH_USDT:.8f} ETH')
                            print(faz_compra)
                            ...
                            config.mensagem_telegram(
                                f'>> VALORES: \nCompra: {vendaAtivoEXC:.8f} \nVenda: {compraAtivoBLEU:.8f} \nQuantidade: {minimaCompra_ETH_USDT:.8f}\n')
                            config.mensagem_telegram(
                                f'>> AÇÃO:\nComprando na EXC... {minimaCompra_ETH_USDT:.8f}\n{faz_compra}\n')
