...
diferencaSatoshi_DCR_DOGE = config.diferencaSatoshi_DCR_DOGE

# minina
minimaCompra_DCR_DOGE = config.minimaCompra_DCR_DOGE
...
while True:
    try:
        ...
        while contador <= 1000000:
            ...
            urlGetOrderBookBLEU_BUY_DCR_DOGE = config.urlGetOrderBookBLEU_BUY_DCR_DOGE
            rBLEU = requests.get(urlGetOrderBookBLEU_BUY_DCR_DOGE)
            jBLEU = json.loads(rBLEU.text)
            quantidade_comprandoBLEU = jBLEU['result']['buy'][0]['Quantity']

            urlGetOrderBookBLEU_SELL_DCR_DOGE = config.urlGetOrderBookBLEU_SELL_DCR_DOGE
            rBLEU = requests.get(urlGetOrderBookBLEU_SELL_DCR_DOGE)
            jBLEU = json.loads(rBLEU.text)
            quantidade_vendendoBLEU = jBLEU['result']['sell'][0]['Quantity']

            urlGetOrderBookEXC_BUY_DCR_DOGE = config.urlGetOrderBookEXC_BUY_DCR_DOGE
            rEXC = requests.get(urlGetOrderBookEXC_BUY_DCR_DOGE)
            jEXC = json.loads(rEXC.text)
            quantidade_comprandoEXC = jEXC['result']['buy'][0]['Quantity']

            urlGetOrderBookEXC_SELL_DCR_DOGE = config.urlGetOrderBookEXC_SELL_DCR_DOGE
            rEXC = requests.get(urlGetOrderBookEXC_SELL_DCR_DOGE)
            jEXC = json.loads(rEXC.text)
            quantidade_vendendoEXC = jEXC['result']['sell'][0]['Quantity']

            # print('-' * 10)

            # print('\nMERCADO EXC: DCR_DOGE')
            urlGettickerEXC = config.urlGettickerEXC_DCR_DOGE
            ...
            # print('\nMERCADO BLEU: DCR_DOGE')
            urlGettickerBLEU = config.urlGettickerBLEU_DCR_DOGE
...
####################################################################################
            ...
            if vendaAtivoBLEU < compraAtivoEXC and compraAtivoEXC - vendaAtivoBLEU > diferencaSatoshi_DCR_DOGE:
                ########################
                #     OPORTUNIDADE     #
                ########################
                print(f'\n>> OPORTUNIDADE << VENDA na BLEU mais barata que COMPRA na EXC e diferença acima de: {diferencaSatoshi_DCR_DOGE:.8f} satoshi\n')
...
##########################################################################################
                    ...
                    faz_compraBLEU = key_secretBLEU.buy_limit('DCR_DOGE', vendaAtivoBLEU, quantidade_vendendoBLEU)
                    ...
                    if respostaFazCompra == 'ERR_INSUFICIENT_BALANCE':
                        ...
                        faz_compra = key_secretBLEU.buy_limit('DCR_DOGE', vendaAtivoBLEU, minimaCompra_DCR_DOGE)
                        print(f'Comprando... {minimaCompra_DCR_DOGE:.8f} DCR')
                        print(faz_compra)

                        # Mensagem Telegram
                        config.mensagem_telegram('>>> FAZENDO COMPRA MÍNIMA <<<')
                        config.mensagem_telegram(f'>> VALORES: \nCompra: {vendaAtivoBLEU:.8f} \nVenda: {compraAtivoEXC:.8f} \nQuantidade: {minimaCompra_DCR_DOGE:.8f}\n')
                        config.mensagem_telegram(f'>> AÇÃO:\nComprando na BLEU... {minimaCompra_DCR_DOGE:.8f}\n{faz_compra}\n')
                        ...
                        ######################################
                        print(f'\nTransferindo... {minimaCompra_DCR_DOGE:.8f} DCR')
                        mCOMPRA = str(minimaCompra_DCR_DOGE)
                        ...
                        ######################################################
                        print(f'\nVENDENDO... {minimaCompra_DCR_DOGE:.8f} DCR')
                        faz_vendaEXC = key_secretEXC.sell_limit('DCR_DOGE', compraAtivoEXC, minimaCompra_DCR_DOGE)
                        print(faz_vendaEXC)
                        ...
                        ##############################################################
                        print('\nVendendo na EXC...')
                        faz_vendaEXC = key_secretEXC.sell_limit('DCR_DOGE', compraAtivoEXC, quantidade_vendendoBLEU)
                        print(faz_vendaEXC)
...
##########################################################################################
                    ...
                    faz_compraBLEU = key_secretBLEU.buy_limit('DCR_DOGE', vendaAtivoBLEU, quantidade_comprandoEXC)
                    ...
                    if respostaFazCompra == 'ERR_INSUFICIENT_BALANCE':
                        ...
                        # Faz TRANSFERÊNCIA da BLEU para EXC #
                        ######################################
                        print(f'Transferindo... {minimaCompra_DCR_DOGE:.8f} DCR')
                        mCOMPRA = str(minimaCompra_DCR_DOGE)
                        urlDirecttransferBLEU = 'https://bleutrade.com/api/v3/private/directtransfer?apikey=' + keyBLEU + '&nonce=' + str(
                            int(
                        ...
                        # Faz VENDA na EXC: MOEDA_MERCADO, preço, quantidade #
                        ######################################################
                        print(f'Vendendo... {minimaCompra_DCR_DOGE:.8f} DCR')
                        faz_vendaEXC = key_secretEXC.sell_limit('DCR_DOGE', compraAtivoEXC, minimaCompra_DCR_DOGE)
                        print(faz_vendaEXC)
                        ...
                        ##############################################################
                        print('\nVendendo na EXC...')
                        faz_vendaEXC = key_secretEXC.sell_limit('DCR_DOGE', compraAtivoEXC, quantidade_comprandoEXC)
                        print(faz_vendaEXC)
...
####################################################################################
            ...
            elif vendaAtivoBLEU < compraAtivoEXC and compraAtivoEXC - vendaAtivoBLEU < diferencaSatoshi_DCR_DOGE:
                print(f'\n>> AGUARDE << VENDA na BLEU mais barata que COMPRA na EXC, mas diferença abaixo de: {diferencaSatoshi_DCR_DOGE:.8f} satoshi\n')
...
####################################################################################
            ...
            if vendaAtivoEXC < compraAtivoBLEU and compraAtivoBLEU - vendaAtivoEXC > diferencaSatoshi_DCR_DOGE:
                ########################
                #     OPORTUNIDADE     #
                ########################
                print(f'\n>> OPORTUNIDADE << VENDA na EXC mais barata que COMPRA na BLEU e diferença acima de: {diferencaSatoshi_DCR_DOGE:.8f} satoshi\n')
...
####################################################################################
                    faz_compraEXC = key_secretEXC.buy_limit('DCR_DOGE', vendaAtivoBLEU, quantidade_vendendoEXC)
                    # print(faz_compra['result'])
                    print(faz_compraEXC)
                    ...
                    if respostaFazCompraEXC == 'ERR_INSUFICIENT_BALANCE':
                        ...
                        ################################################################
                        print(' >>> FAZENDO COMPRA MÍNIMA <<<\n')
                        faz_compra = key_secretEXC.buy_limit('DCR_DOGE', vendaAtivoEXC, minimaCompra_DCR_DOGE)
                        print(f'COMPRANDO... {minimaCompra_DCR_DOGE:.8f} DCR')
                        print(faz_compra)
                        ...
                        config.mensagem_telegram('>>> FAZENDO COMPRA MÍNIMA <<<')
                        config.mensagem_telegram(f'>> VALORES: \nCompra: {vendaAtivoEXC:.8f} \nVenda: {compraAtivoBLEU:.8f} \nQuantidade: {minimaCompra_DCR_DOGE:.8f}\n')
                        config.mensagem_telegram(f'>> AÇÃO:\nComprando na EXC... {minimaCompra_DCR_DOGE:.8f}\n{faz_compra}\n')
                        ...
                        ######################################################
                        print(f'VENDENDO... {minimaCompra_DCR_DOGE:.8f} DCR')
                        faz_vendaBLEU = key_secretBLEU.sell_limit('DCR_DOGE', compraAtivoBLEU, minimaCompra_DCR_DOGE)
                        print(faz_vendaBLEU)
                        ...
                        faz_vendaBLEU = key_secretBLEU.sell_limit('DCR_DOGE', compraAtivoEXC, quantidade_vendendoEXC)
                        print(faz_vendaBLEU)
...
####################################################################################
                    ...
                    faz_compraEXC = key_secretEXC.buy_limit('DCR_DOGE', vendaAtivoBLEU, quantidade_comprandoBLEU)
                    # print(faz_compra['result'])
                    print(faz_compraEXC)
                    respostaResult = faz_compraEXC['result']
                    ...
                    if respostaFazCompraEXC == 'ERR_INSUFICIENT_BALANCE':
                        ...
                        faz_vendaBLEU = key_secretBLEU.sell_limit('DCR_DOGE', compraAtivoEXC, quantidade_comprandoBLEU)
                        print(faz_vendaBLEU)
...
####################################################################################
            ...
            elif vendaAtivoEXC < compraAtivoBLEU and compraAtivoBLEU - vendaAtivoEXC < diferencaSatoshi_DCR_DOGE:
                print(f'\n>> AGUARDE << Venda na EXC está mais barata que compra na BLEU, mas diferença abaixo de {diferencaSatoshi_DCR_DOGE:.8f} satoshi\n')
