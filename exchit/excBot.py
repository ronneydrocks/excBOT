...
class excBot:
    ...
    # Construtor
    def __init__(self, apikey=None, apisecret=None, nonce=False, baseurl='https://trade.exccripto.com/api/v3/'):
        self._url = ''
    ...
    def fazer_chamada_api_privada(self, query):
        ...
        # print(self.form_hash_url())       # PRINT AJUDA
